...
$(document).on("close.bs.alert","#privacy-info", function(e){
...
function get_stats() {
    ...
    $.post( "/stat",data_in).done(function (data) {
        ...
        $('#good_things_today').text(data.posts_today + ' Memories Today');
        $('#good_things_total').text(data.posts + ' Total Memories');
